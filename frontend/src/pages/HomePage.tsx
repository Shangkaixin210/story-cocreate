...
const CHANNEL_LABEL: Record<string, string> = { '4-7': '🧒 幼儿通道 4-7岁', '8-12': '🧑 学龄通道 8-12岁' };
      ...
      <div className="home-hero">
        ...
        {user?.age_group && (
          <div className="home-channel">
            <span className="home-channel-label">{CHANNEL_LABEL[user.age_group] || user.age_group}</span>
            <button className="home-channel-switch" onClick={() => switchChannel(user.age_group === '4-7' ? '8-12' : '4-7')}>
              🔄 切换
            </button>
          </div>
        )}
